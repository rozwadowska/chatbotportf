...
if (imie[-1] == 'a'):
    print("Dzieki", imie, "ze sie przedstawilas :)")
else:
    print ("Dzieki", imie, ",ze sie przedstawiles :)")
...
cenaNetto = int(input ("Ok. To jeszcze ostatnie zadanie. Podaj cene netto dodwolnego produktu. "))
print (cenaBrutto = cenaNetto * obliczonyVAT)
"""
